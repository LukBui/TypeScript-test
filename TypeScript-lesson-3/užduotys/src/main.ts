...
{
  function arrayIndex(arr: any[]): void {
...
{
  function arrayIndexRows(arr: any[]): void {
...
{
  function arrayValueRows(arr: any[]): void {
...
{
  function indexValuesRows(arr: any[]): void {
...
{
  function reversRows(arr: any[]): void {
...
{
  function arrayElementsIndexSpread(arr: any[]): void {
...
{
  function arrayElementsValuesSpread(arr: any[]): void {
    const res = arr.join(' ');
    console.log(res);
    // console.log(...arr);
  }
...
{
  function indexValuesCouples(arr: any[]): void {
...
{
  function arrayMultiplier(arr: number[]): number[] {
...
{
  function arraySquare(arr: number[]): number[] {
    return arr.map(x => x ** 2);
  }
...
{
  function elementIndexMultiplication(arr: number[]): number[] {
...
{
  function notPositiveNumebrs(arr: number[]): number[] {
    return arr.filter((x) => x <= 0);
  }
